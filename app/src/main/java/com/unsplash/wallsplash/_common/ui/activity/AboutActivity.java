    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.container_about_gitHubContainer:
                LinkUtils.accessLink(this, WallSplashApplication.AUTHOR_GITHUB);
                break;
            ...
            case R.id.container_about_sourceCodeContainer:
                LinkUtils.accessLink(this, WallSplashApplication.MYSPLASH_GITHUB);
                break;

            case R.id.container_about_unsplashContainer:
                LinkUtils.accessLink(this, WallSplashApplication.UNSPLASH_URL);
                break;
