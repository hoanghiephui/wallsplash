package com.unsplash.wallsplash.common.ui.activity;
...
public class LoginActivity extends BaseActivity
    ...
    public void onNewIntent(Intent intent) {
        ...
        if (intent != null
                ...
                && WallSplashApplication.UNSPLASH_LOGIN_CALLBACK.equals(intent.getData().getAuthority())) {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.activity_login_loginBtn:
                LinkUtils.accessLink(this, WallSplashApplication.UNSPLASH_LOGIN_URL);
                break;

            case R.id.activity_login_joinBtn:
                LinkUtils.accessLink(this, WallSplashApplication.UNSPLASH_JOIN_URL);
                break;
        }
    }
